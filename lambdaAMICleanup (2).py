...
images = ec2.images.filter(Owners=["132833855232"])
#images = ec2.images
...
def lambda_handler(event, context):
	...
	imagecount = 0
        ...
        for image in images:
	        ...
	        imagecount = imagecount + 1
				...
				if image.name.index(date_fmt) > 0:
    ...
    if backupSuccess == True:
        ...
        snapshots = ec.describe_snapshots(MaxResults=1000, OwnerIds=['132833855232'])['Snapshots']
